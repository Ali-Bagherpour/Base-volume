/**
         * Groovy Music - Complete Logic for Main Page
         * Includes: Live Search, Advanced Player, Recents, Favourites
         */
        ...
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            function loadSong(index) {
                ...
                if (heroTitle) {
                    ...
                    // Use fallback if cover is missing or broken
            ...
            function addSongToRecents(song) {
                ...
                // Update the mini recent list on the sidebar if it exists or in the main grid
                if(recentList) {
                    renderRecentList(recents.slice(0, 5)); // Show top 5 in mini list
                }
            }
            ...
            function renderRecentList(songs) {
                ...
                songs.forEach((song, idx) => {
                    ...
                    li.addEventListener('click', () => {
                        // Play this song. Note: We create a temporary playlist for recents if clicked from here,
                        // or just play it individually. For simplicity, we play it and set context.
                        currentPlaylist = songs;
                        currentSongIndex = idx;
                        loadSong(idx);
                        playSong();
            ...
            function initializeUI() {
                ...
                // Initialize Recents List in sidebar
